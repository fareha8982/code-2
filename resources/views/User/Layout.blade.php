			...
			<div class="row justify-content-between">
				<div class="col-md-8 order-md-last">
					<div class="row">
						...
						<!--User profile starts-->
<div class="col-md-6 d-md-flex justify-content-end align-items-center mb-md-0 mb-3">
  
  <!-- Search bar -->
  <form action="#" class="searchform mr-3">
  ...
  <a href="/dashboard" class="brand-link d-flex align-items-center">
    <img src="{{ asset('userprofiles/userprofile.jpg') }}"
         ...
         style="width:40px;height:40px;object-fit:cover;opacity:.8;border-radius: 50%;">
  </a>@endauth
	    ...
	    <div class="container-fluid">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	...
	        	<!-- <li class="nav-item"><a href="{{ url('/about') }} " class="nav-link">Coming Soon</a></li> -->
	        	<!-- <li class="nav-item"><a href="{{ url('/about') }}" class="nav-link">Top Seller</a></li> -->
	        	<li class="nav-item"><a href="{{ url('/user-book') }}" class="nav-link">Books</a></li>
