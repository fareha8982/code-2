...
<section class="hero-wrap" style="background-image: url('{{ asset('User/images/bg_1.jpg') }}');" data-stellar-background-ratio="0.5">
	...
	<section class="ftco-section">
			<div class="container">
				<div class="row">
					<div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url('{{ asset('User/images/about-1.jpg') }}');">
					</div>
    		...
    		<div class="row">
    			<div class="col-md-6 col-lg-4 d-flex">
    				<div class="book-wrap d-lg-flex">
    					<div class="img d-flex justify-content-end" style="background-image: url('{{ asset('User/images/book-1.jpg') }}');">
    						<div class="in-text">
    					...
    					<div class="text p-4">
    						<p class="mb-2"><span class="price">RS: 1200</span></p>
    			...
    			<div class="col-md-6 col-lg-4 d-flex">
    				<div class="book-wrap d-lg-flex">
    					<div class="img d-flex justify-content-end" style="background-image: url('{{ asset('User/images/book-2.jpg') }}');">
    						<div class="in-text">
    							<a href="#" class="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
    								<span class="flaticon-shopping-cart"></span>
    							</a>
    					...
    					<div class="text p-4">
    						<p class="mb-2"><span class="price sale">RS:700</span> <span class="price">RS:800</span></p>
    			...
    			<div class="col-md-6 col-lg-4 d-flex">
    				<div class="book-wrap d-lg-flex">
    					<div class="img d-flex justify-content-end" style="background-image: url('{{ asset('User/images/book-3.jpg') }}');">
    						<div class="in-text">
    							<a href="#" class="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
    								<span class="flaticon-shopping-cart"></span>
    							</a>
    					...
    					<div class="text p-4">
    						<p class="mb-2"><span class="price">RS: 1500</span></p>
    						<h2><a href="#">Your Soul Is A River</a></h2>
    						<span class="position">By J.K.Rowling</span>
    					</div>
    				</div>
    			</div>
    			...
    			<div class="col-md-6 col-lg-4 d-flex">
    				<div class="book-wrap d-lg-flex">
    					<div class="img d-flex justify-content-end" style="background-image: url('{{ asset('User/images/book-4.jpg') }}');">
    						<div class="in-text">
    							<a href="#" class="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
    								<span class="flaticon-shopping-cart"></span>
    							</a>
    					...
    					<div class="text p-4 order-md-first">
    						<p class="mb-2"><span class="price">RS: 900</span></p>
    			...
    			<div class="col-md-6 col-lg-4 d-flex">
    				<div class="book-wrap d-lg-flex">
    					<div class="img d-flex justify-content-end" style="background-image: url('{{ asset('User/images/book-5.jpg') }}');">
    						<div class="in-text">
    							<a href="#" class="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
    								<span class="flaticon-shopping-cart"></span>
    							</a>
    					...
    					<div class="text p-4 order-md-first">
    						<p class="mb-2"><span class="price">RS: 2000</span></p>
    						<h2><a href="#">Happy</a></h2>
    						<span class="position">By Emily Brontë</span>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-4 d-flex">
    				<div class="book-wrap d-lg-flex">
    					<div class="img d-flex justify-content-end" style="background-image: url('{{ asset('User/images/book-6.jpg') }}');">
    						<div class="in-text">
    							<a href="#" class="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
    								<span class="flaticon-shopping-cart"></span>
    							</a>
    ...
    <section class="ftco-section testimony-section ftco-no-pb">
    	<div class="img img-bg border" style="background-image: url('{{ asset('User/images/bg_4.jpg') }}');"></div>
    	<div class="overlay"></div>
      <div class="container">
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url('{{ asset('User/images/person_1.jpg') }}')"></div>
                    	<div class="pl-3">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url('{{ asset('User/images/person_2.jpg') }}')"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url('{{ asset('User/images/person_3.jpg') }}')"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text text-center">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('{{ asset('User/images/image_1.jpg') }}');">
	              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <div class="text text-center">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('{{ asset('User/images/image_2.jpg') }}');">
	              </a>
	              <div class="meta text-center mb-2 d-flex align-items-center justify-content-center">
                	<div>
                		<span class="day">02</span>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <div class="text text-center">
              	<a href="blog-single.html" class="block-20 img" style="background-image: url('{{ asset('User/images/image_3.jpg') }}');">
	              </a>
	              <div class="meta text-center mb-2 d-flex align-items-center justify-content-center">
                	<div>
                		<span class="day">02</span>
